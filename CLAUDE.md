...
**当前阶段：v0.1/v0.2/v0.3/v0.4 已发版（git tag v0.1/v0.2/v0.3/v0.4，v0.4 于 2026-09-01 用户复核通过：复核反馈 #1-#5 全部处理）。v0.5 SEO + 扒图延后不排期（决策 33，v0.4 定时闭环已验证"真能用"，启动前先出详设 v0.5）。** 路线：需求分析 ✅ → 概设 ✅ → 详设 ✅（v0.1/v0.2/v0.3/v0.4）→ 页面原型 ✅ → 开发 ✅（v0.1/v0.2/v0.3/v0.4）→ 测试 ✅（A1-A11 + A12-A26 + A27-A37 + A38-A45）→ 集成验收 ✅ → 复核 ✅（v0.1/v0.2/v0.3/v0.4 tag）→ v0.5 启动（待议）。v0.6 ERP 延后不排期，v0.7 权限系统。
