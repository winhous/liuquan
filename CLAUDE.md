...
- `docs/概要设计-v0.3.md` - 概设 v0.3（业务拍板基线，9 章）
- `docs/开发规范.md` - 开发唯一准则源：20 条可判定规矩（R1-R20）+ 验收检查表
- `docs/版本规划.md` - 版本里程碑 v0.1~v1.0（版本 = 能力里程碑，不做待办堆叠）
- `docs/变更日志.md` - 改动流水账（只增不减，「因为…所以…」格式）
